...
export const COMPARISON_OPTIONS = [
  ...
  { key: "teto",  label: "Teto Laminado" },
  { key: "tinta", label: "Tinta" },
];

type RowKey = "mdf" | "papel" | "forro" | "teto" | "tinta";

const rows: { attr: string; pfb: string; mdf: string; papel: string; forro: string; teto: string; tinta: string; highlight: boolean }[] = [
  {
  ...
  },
  {
    ...
    teto: "Plástico brilhante ou opaco",
