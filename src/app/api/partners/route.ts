      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;color:#1a1a1a">
            ...
            <p style="color:#555;margin-bottom:24px">Você foi cadastrado como parceiro da <strong>Orbital Revestimentos</strong>. Aqui estão suas credenciais de acesso ao portal:</p>

            <div style="background:#f5f5f3;border:1px solid #e2e2e2;padding:20px 24px;margin-bottom:16px">
              <p style="margin:0 0 4px 0;font-size:11px;text-transform:uppercase;letter-spacing:0.12em;color:#74777f">Seu código de cupom (login)</p>
